    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "Wilbur Snake<p></p>Use the <strong>arrow keys</strong> on your keyboard to eat up the Sun Devils. " + fullScreenText + "<p></p>";
        ...
        function createGameEndElement(message, elmId, elmClassName) {
            ...
            gameEndTxt.innerHTML = "Wilbur Snake<p></p>" + message + "<p></p>";
